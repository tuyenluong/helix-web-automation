...
public class AopConstant {
    ...
    public static final String SESSIONS_ON_START_TEST_LISTENER_POINT_CUT = "execution(void ioc.listeners.TestListener.onTestStart(..))";
    ...
    public static final String SESSIONS_FIELD_POINT_CUT = "get(ioc.ITestSession *..*) && @annotation(ioc.AnnoTestSession) && !within(ioc.listeners..*)";
